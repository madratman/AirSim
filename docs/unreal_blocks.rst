...
#. Make sure you have `installed Unreal and built AirSim <build_windows.md>`_.
...
#. Press the Play button in Unreal Editor and you will see something like in below video. Also see `how to use AirSim <https://github.com/Microsoft/AirSim/#how-to-use-it>`_.
...
#. Make sure you have `built the Unreal Engine and AirSim <build_linux.md>`_.
#. Navigate to your UnrealEngine repo folder and run ``Engine/Binaries/Linux/UE4Editor`` which will start Unreal Editor.
#. On first start you might not see any projects in UE4 editor. Click on Projects tab, Browse button and then navigate to ``AirSim/Unreal/Environments/Blocks/Blocks.uproject``. 
...
#. Press the Play button in Unreal Editor and you will see something like in below video. Also see `how to use AirSim </#how-to-use-it>`_.


.. image:: images/blocks_video.png
   :target: https://www.youtube.com/watch?v=-r_QGaxMT4A
   :alt: Blocks Demo Video
...
By default AirSim spawns multirotor. You can easily change this to car and use all of AirSim goodies. Please see `using car <using_car.md>`_ guide.
